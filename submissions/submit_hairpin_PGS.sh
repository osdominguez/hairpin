    ...
    for p_value in "${pvals[@]}"; do 
      ...
      #run odd chromosome PRS
       [ ! -f /scratch/osdominguez/prs_hairpin_outputs/odd/${12}_prs_${pc_n}pc_${p_value}pval.best ] && \
        sbatch /gpfs/data/ukb-share/dahl/ophelia/hairpin/PGS/hairpin_PGS.sh \
...
#sub_phenotype EA4_additive_excl_23andMe.txt F Eduscore_eng/Eduscore_eng674178.pheno Beta rsID Chr not_avail Effect_allele Other_allele P beta edu_years EAF_HRC:0.05